...
,["void","CPCollectionView"]), new objj_method(sel_getUid("init"), function $ApplicationView__init(self, _cmd)
{
        ...
        var items = [];
    {
        ...
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", "en/Applications/TestApp2/icon.png", CGSizeMake(200.0, 200.0));
    ...
    }
    {
        ...
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", "en/Applications/TestApp1/icon.png", CGSizeMake(200.0, 200.0));
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
        items.push(item);
    }
    {
        var app = objj_msgSend(objj_msgSend(DesignerApp, "alloc"), "init");
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", "en/Applications/DesignerApp/icon.png", CGSizeMake(200.0, 200.0));
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
        items.push(item);
    }
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $TestApp2ViewController__init(self, _cmd)
{
    ...
    {
        var bundle = objj_msgSend(CPBundle, "mainBundle");
        var image = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "en/Applications/TestApp2/icon.png");
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $TestApp1ViewController__init(self, _cmd)
{
    ...
    {
        var bundle = objj_msgSend(CPBundle, "mainBundle");
        var image = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "en/Applications/TestApp1/icon.png");
...
,["int","CPTableView"]), new objj_method(sel_getUid("tableView:objectValueForTableColumn:row:"), function $ToolBoxView__tableView_objectValueForTableColumn_row_(self, _cmd, aTableView, aColumn, aRowIndex)
{
    ...
    return objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "en/Applications/DesignerApp/Images/" + self.elements[aRowIndex] + ".png");
}
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $ContentView__init(self, _cmd)
{
    ...
    if (self)
    {
        ...
        objj_msgSend(self, "setAutoresizingMask:", CPViewWidthSizable | CPViewHeightSizable);
        objj_msgSend(self, "setDelegate:", self);
        var mainBackground = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "en/Applications/DesignerApp/910.jpg");
