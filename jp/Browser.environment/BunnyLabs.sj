...
,["void","CPString"])]);
}p;15;SessionWindow.jt;28771;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;20;TextFieldWithLabel.jt;28678;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("TextFieldWithLabel.j", YES);var LOGIN_STATE = 1;
...
,["void","TextFieldWithLabel"]), new objj_method(sel_getUid("_update"), function $SessionWindow___update(self, _cmd)
{
    ...
    case CHANGEPASSWORD_STATE:
        ...
        break;
    case WAITING_STATE:
        objj_msgSend(self, "setTitle:", "translation missing: jp.please_wait");
        objj_msgSend(self.usernameField, "setHidden:", YES);
        objj_msgSend(self.passwordField, "setHidden:", YES);
        objj_msgSend(self.passwordConfirmField, "setHidden:", YES);
        objj_msgSend(self.emailField, "setHidden:", YES);
