...
,["void","CPNotification"])]);
}p;15;AppController.jt;5484;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;16;DesktopManager.ji;16;SessionManager.ji;13;MenuManager.ji;20;ApplicationManager.ji;14;AdminManager.ji;29;BunnyLabsIconViewController.ji;20;Utils/HashFragment.jt;5254;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("DesktopManager.j", YES);objj_executeFile("SessionManager.j", YES);objj_executeFile("MenuManager.j", YES);objj_executeFile("ApplicationManager.j", YES);objj_executeFile("AdminManager.j", YES);objj_executeFile("BunnyLabsIconViewController.j", YES);objj_executeFile("Utils/HashFragment.j", YES);{var the_class = objj_allocateClassPair(CPView, "MyWebView"),
...
,["void","CGRect"]), new objj_method(sel_getUid("handleSessionManagerMessage:"), function $SessionManager__handleSessionManagerMessage_(self, _cmd, anObject)
{
    ...
    if (anObject.type === "githubLogin")
    {
        ...
        else if (anObject.error)
        {
            ...
            ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setCustomError:", CPString.isa.objj_msgSend2(CPString, "stringWithFormat:", "Githubでログインすることできません。原因: %@", anObject.error)));
...
,["id","id"]), new objj_method(sel_getUid("getUserData"), function $SessionManager__getUserData(self, _cmd)
{
    ...
    {
        self.userData = nil;
        ((___r1 = self.statusMenuItem), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setTitle:", "ログイン"));
...
,["void","int","CPString"]), new objj_method(sel_getUid("getUserDataHandler:forData:"), function $SessionManager__getUserDataHandler_forData_(self, _cmd, statusCode, data)
{
    if (statusCode == 200)
    {
        ...
        ((___r1 = self.statusMenuItem), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setTitle:", CPString.isa.objj_msgSend2(CPString, "stringWithFormat:", "%@さん", result.username)));
...
,["void","int","CPString"]), new objj_method(sel_getUid("registerResponseHandler:forData:"), function $SessionManager__registerResponseHandler_forData_(self, _cmd, statusCode, data)
{
    if (statusCode == 200)
    {
        ...
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setCustomMessage:", "仮登録は完了しました。ログインできる前にメールに遅れたアクティベーションリンクをクリックすることが必要です"));
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "update"));
    }
    else
    {
...
,["void","int","CPString"]), new objj_method(sel_getUid("submitUsernameResponseHandler:forData:"), function $SessionManager__submitUsernameResponseHandler_forData_(self, _cmd, statusCode, data)
{
    ...
    {
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setState:", SessionWindow.isa.objj_msgSend0(SessionWindow, "loginState")));
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setCustomMessage:", "パスワードは変更しました。新しいパスワードを使ってログインすることができます"));
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "update"));
    }
    else
    {
...
,["void","int","CPString"]), new objj_method(sel_getUid("forgotPasswordResponseHandler:forData:"), function $SessionManager__forgotPasswordResponseHandler_forData_(self, _cmd, statusCode, data)
{
    ...
    {
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setState:", SessionWindow.isa.objj_msgSend0(SessionWindow, "loginState")));
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setCustomMessage:", "パスワードを変更する手続き説明はメールに送りました"));
        ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "update"));
    }
    else
    {
...
{
    var query = {auth: self.isa.objj_msgSend0(self, "authToken"), lang: "jp"};
...
,["void","CPURLConnection"]), new objj_method(sel_getUid("connectionDidReceiveAuthenticationChallenge:"), function $SessionManager__connectionDidReceiveAuthenticationChallenge_(self, _cmd, connection)
{
    ...
    self.isa.objj_msgSend0(self, "getUserData");
    self.isa.objj_msgSend0(self, "showLoginWindow");
    ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setCustomMessage:", "ログインが必要です"));
    ((___r1 = self.isa.objj_msgSend0(self, "view")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "update"));
    var ___r1;
}
...
}p;15;SessionWindow.jt;56208;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;20;TextFieldWithLabel.jt;56115;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("TextFieldWithLabel.j", YES);var LOGIN_STATE = 1;
...
,["void","CPString"]), new objj_method(sel_getUid("init"), function $SessionWindow__init(self, _cmd)
{
    ...
    if (self)
    {
        ...
        self.loginButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "ログイン");
        ...
        self.newAccountButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "新規登録");
        ...
        self.forgotPasswordButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "パスワードを忘れた");
        ...
        self.registerButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "情報確認");
        ...
        self.changePasswordButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "パスワード確認");
        ...
        self.submitUsernameButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "確認");
        ...
        self.logoutButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "ログアウト");
        ...
        self.cancelButton = CPButton.isa.objj_msgSend1(CPButton, "buttonWithTitle:", "キャンセル");
        ...
        self.usernameField = ((___r1 = TextFieldWithLabel.isa.objj_msgSend0(TextFieldWithLabel, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend3(___r1, "initWithLabel:andPlaceHolder:andWidth:", "ユーザーネーム:", "ユーザーネーム", self.LOGIN_BOX_WIDTH - 20));
        ...
        self.passwordField = ((___r1 = TextFieldWithLabel.isa.objj_msgSend0(TextFieldWithLabel, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend(___r1, "initWithLabel:andPlaceHolder:andWidth:isSecure:", "パスワード:", "パスワード", self.LOGIN_BOX_WIDTH - 20, YES));
        ...
        self.passwordConfirmField = ((___r1 = TextFieldWithLabel.isa.objj_msgSend0(TextFieldWithLabel, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend(___r1, "initWithLabel:andPlaceHolder:andWidth:isSecure:", "パスワード再入力:", "パスワード再入力", self.LOGIN_BOX_WIDTH - 20, YES));
        ...
        self.emailField = ((___r1 = TextFieldWithLabel.isa.objj_msgSend0(TextFieldWithLabel, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend3(___r1, "initWithLabel:andPlaceHolder:andWidth:", "メールアドレス:", "メールアドレス", self.LOGIN_BOX_WIDTH - 20));
...
,["id","id"]), new objj_method(sel_getUid("usernameIsValid:"), function $SessionWindow__usernameIsValid_(self, _cmd, username)
{
    ...
    {
        ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", CPString.isa.objj_msgSend2(CPString, "stringWithFormat:", "ユーザーネームは%d桁以上が必要です", MINIMUM_USERNAME_LENGTH)));
        return NO;
    }
    ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "removeObject:", CPString.isa.objj_msgSend2(CPString, "stringWithFormat:", "ユーザーネームは%d桁以上が必要です", MINIMUM_USERNAME_LENGTH)));
    return YES;
    var ___r1;
}
,["BOOL","CPString"]), new objj_method(sel_getUid("passwordIsValid:"), function $SessionWindow__passwordIsValid_(self, _cmd, password)
{
    ...
    {
        ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", CPString.isa.objj_msgSend2(CPString, "stringWithFormat:", "パスワードは%d文字以上が必要です", MINIMUM_PASSWORD_LENGTH)));
        return NO;
    }
    ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "removeObject:", CPString.isa.objj_msgSend2(CPString, "stringWithFormat:", "パスワードは%d文字以上が必要です", MINIMUM_PASSWORD_LENGTH)));
    return YES;
    var ___r1;
}
,["BOOL","CPString"]), new objj_method(sel_getUid("passwordsMatch:"), function $SessionWindow__passwordsMatch_(self, _cmd, password)
{
    ...
    {
        ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", "パスワードが一致しません"));
        return NO;
    }
    ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "removeObject:", "パスワードが一致しません"));
    return YES;
    var ___r1;
}
,["BOOL","CPString"]), new objj_method(sel_getUid("emailIsValid:"), function $SessionWindow__emailIsValid_(self, _cmd, email)
{
    ...
    {
        ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", "メールアドレスは"));
        return NO;
    }
    ((___r1 = self.errors), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "removeObject:", "メールアドレスは"));
    return YES;
    var ___r1;
}
...
,["void"]), new objj_method(sel_getUid("_update"), function $SessionWindow___update(self, _cmd)
{
    ...
    switch(self.currentState) {
    case LOGIN_STATE:
        self.isa.objj_msgSend1(self, "setTitle:", "ログイン");
        ...
        break;
    case REGISTRATION_STATE:
        self.isa.objj_msgSend1(self, "setTitle:", "新規登録");
        ((___r1 = self.usernameField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", NO));
        ((___r1 = self.passwordField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", NO));
        ...
        break;
    case FORGOTPASSWORD_STATE:
        self.isa.objj_msgSend1(self, "setTitle:", "パスワードを忘れた");
        ((___r1 = self.usernameField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", NO));
        ...
        break;
    case CHANGEPASSWORD_STATE:
        self.isa.objj_msgSend1(self, "setTitle:", "パスワード変更");
        ...
        break;
    case LOGOUT_STATE:
        self.isa.objj_msgSend1(self, "setTitle:", "ログアウト");
        ((___r1 = self.usernameField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ((___r1 = self.passwordField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ((___r1 = self.passwordConfirmField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ((___r1 = self.emailField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ...
        break;
    case WAITING_STATE:
        self.isa.objj_msgSend1(self, "setTitle:", "しばらくお待ちください");
        ((___r1 = self.usernameField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ((___r1 = self.passwordField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ((___r1 = self.passwordConfirmField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
        ((___r1 = self.emailField), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHidden:", YES));
