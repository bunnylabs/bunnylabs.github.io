...
,["void","CPNotification"])]);
}p;17;ApplicationInfo.jt;1730;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;1663;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPObject, "ApplicationInfo"),
...
{
    var bundle = objj_msgSend(CPBundle, "bundleWithIdentifier:", objj_msgSend(self.application, "bundleIdentifier"));
    var name = objj_msgSend(objj_msgSend(bundle, "infoDictionary"), "objectForKey:", "CPBundleName");
    return name;
}
,["CPString"])]);
...
,["ApplicationManager"])]);
}p;17;ApplicationView.jt;3939;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;17;ApplicationInfo.ji;20;IconCollectionView.ji;43;Frameworks/Applications/TestApp2/TestApp2.ji;43;Frameworks/Applications/TestApp1/TestApp1.ji;49;Frameworks/Applications/DesignerApp/DesignerApp.jt;3675;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("ApplicationInfo.j", YES);objj_executeFile("IconCollectionView.j", YES);objj_executeFile("Frameworks/Applications/TestApp2/TestApp2.j", YES);objj_executeFile("Frameworks/Applications/TestApp1/TestApp1.j", YES);objj_executeFile("Frameworks/Applications/DesignerApp/DesignerApp.j", YES);{var the_class = objj_allocateClassPair(CPView, "ApplicationView"),
...
,["void","CPCollectionView"]), new objj_method(sel_getUid("init"), function $ApplicationView__init(self, _cmd)
{
    ...
    if (self)
    {
        ...
        var items = [];
    {
        var app = objj_msgSend(objj_msgSend(TestApp2, "alloc"), "init");
        var appBundle = objj_msgSend(CPBundle, "bundleWithIdentifier:", objj_msgSend(app, "bundleIdentifier"));
        ...
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
        items.push(item);
    }
    {
        var app = objj_msgSend(objj_msgSend(TestApp1, "alloc"), "init");
        var appBundle = objj_msgSend(CPBundle, "bundleWithIdentifier:", objj_msgSend(app, "bundleIdentifier"));
        var file = objj_msgSend(appBundle, "pathForResource:", "Images/icon.png");
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", file, CGSizeMake(200.0, 200.0));
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
    ...
    {
        var app = objj_msgSend(objj_msgSend(DesignerApp, "alloc"), "init");
        var appBundle = objj_msgSend(CPBundle, "bundleWithIdentifier:", objj_msgSend(app, "bundleIdentifier"));
        var file = objj_msgSend(appBundle, "pathForResource:", "Images/icon.png");
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", file, CGSizeMake(200.0, 200.0));
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
...
,["void"])]);
}p;52;Frameworks/Applications/DesignerApp/WorkspaceModel.jt;286;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;220;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPObject, "WorkspaceModel"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
}p;48;Frameworks/Applications/DesignerApp/UITreeView.jt;1674;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;1607;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPView, "UITreeView"),
...
,["id"])]);
}p;49;Frameworks/Applications/DesignerApp/ToolBoxView.jt;2768;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;2701;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPView, "ToolBoxView"),
...
}p;63;Frameworks/Applications/DesignerApp/DesignerAppViewController.jt;1157;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;17;DesignerAppView.jt;1068;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("DesignerAppView.j", YES);{var the_class = objj_allocateClassPair(CPViewController, "DesignerAppViewController"),
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $DesignerAppViewController__init(self, _cmd)
{
    ...
    if (self)
    {
        self.view = objj_msgSend(objj_msgSend(DesignerAppView, "alloc"), "init");
        objj_msgSend(self, "setView:", self.view);
    }
    return self;
}
...
,["BOOL"])]);
}p;53;Frameworks/Applications/DesignerApp/DesignerAppView.jt;2709;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;13;ContentView.jt;2624;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("ContentView.j", YES);var TOPBARHEIGHT = 30;
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $DesignerAppView__init(self, _cmd)
{
    ...
    if (self)
    {
        ...
        self.splitView = objj_msgSend(objj_msgSend(ContentView, "alloc"), "init");
...
,["void","CPSplitView","CGSize"])]);
}p;49;Frameworks/Applications/DesignerApp/DesignerApp.jt;958;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;27;DesignerAppViewController.jt;860;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);var BUNDLE_IDENTIFIER = "net.astrobunny.bunnylabs.DesignerApp";
...
,["CPString"]), new objj_method(sel_getUid("viewController"), function $DesignerApp__viewController(self, _cmd)
{
    if (!self.controller)
    {
        self.controller = objj_msgSend(objj_msgSend(DesignerAppViewController, "alloc"), "init");
    }
    return self.controller;
}
,["CPViewController"])]);
}p;49;Frameworks/Applications/DesignerApp/ContentView.jt;4452;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;12;UITreeView.ji;13;ToolBoxView.jt;4350;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("UITreeView.j", YES);objj_executeFile("ToolBoxView.j", YES);var MINSIDEBARWIDTH = 200;
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $ContentView__init(self, _cmd)
{
    ...
    if (self)
    {
        ...
        objj_msgSend(self, "setAutoresizingMask:", CPViewWidthSizable | CPViewHeightSizable);
        objj_msgSend(self, "setDelegate:", self);
        var bundle = objj_msgSend(CPBundle, "bundleWithIdentifier:", "net.astrobunny.bunnylabs.DesignerApp");
...
,["void","CPSplitView","CGSize"])]);
}p;43;Frameworks/Applications/TestApp1/TestApp1.jt;2077;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;2010;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);var BUNDLE_IDENTIFIER = "net.astrobunny.bunnylabs.TestApp1";
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $TestApp1ViewController__init(self, _cmd)
{
    ...
    if (self)
    {
        var bundle = objj_msgSend(CPBundle, "bundleWithIdentifier:", BUNDLE_IDENTIFIER);
        var file = objj_msgSend(bundle, "pathForResource:", "Images/icon.png");
        var image = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", file);
...
,["CPString"]), new objj_method(sel_getUid("viewController"), function $TestApp1__viewController(self, _cmd)
{
    if (!self.controller)
    {
        self.controller = objj_msgSend(objj_msgSend(TestApp1ViewController, "alloc"), "init");
    }
    return self.controller;
}
,["CPViewController"])]);
}p;43;Frameworks/Applications/TestApp2/TestApp2.jt;2077;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;2010;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);var BUNDLE_IDENTIFIER = "net.astrobunny.bunnylabs.TestApp2";
...
,["CPString"]), new objj_method(sel_getUid("viewController"), function $TestApp2__viewController(self, _cmd)
{
    if (!self.controller)
    {
        self.controller = objj_msgSend(objj_msgSend(TestApp2ViewController, "alloc"), "init");
    }
    return self.controller;
}
,["CPViewController"])]);
