@STATIC;1.0;p;17;ApplicationInfo.jt;1544;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;1477;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPObject, "ApplicationInfo"),
...
{
    return objj_msgSend(self.application, "name");
}
,["CPString"])]);
...
,["CPString"])]);
}p;17;ApplicationView.jt;3384;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;17;ApplicationInfo.ji;20;IconCollectionView.ji;32;Applications/TestApp2/TestApp2.ji;32;Applications/TestApp1/TestApp1.ji;38;Applications/DesignerApp/DesignerApp.jt;3153;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("ApplicationInfo.j", YES);objj_executeFile("IconCollectionView.j", YES);objj_executeFile("Applications/TestApp2/TestApp2.j", YES);objj_executeFile("Applications/TestApp1/TestApp1.j", YES);objj_executeFile("Applications/DesignerApp/DesignerApp.j", YES);{var the_class = objj_allocateClassPair(CPView, "ApplicationView"),
...
,["void","CPCollectionView"]), new objj_method(sel_getUid("init"), function $ApplicationView__init(self, _cmd)
{
        ...
        var items = [];
    {
        ...
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", "jp/Applications/TestApp2/icon.png", CGSizeMake(200.0, 200.0));
    ...
    }
    {
        ...
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", "jp/Applications/TestApp1/icon.png", CGSizeMake(200.0, 200.0));
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
        items.push(item);
    }
    {
        var app = objj_msgSend(objj_msgSend(DesignerApp, "alloc"), "init");
        var icon = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", "jp/Applications/DesignerApp/icon.png", CGSizeMake(200.0, 200.0));
        var item = objj_msgSend(ApplicationInfo, "applicationInfoOf:withIcon:", app, icon);
        items.push(item);
    }
...
,["id"])]);
}p;32;Applications/TestApp2/TestApp2.jt;1918;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;1851;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPViewController, "TestApp2ViewController"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $TestApp2ViewController__init(self, _cmd)
{
    ...
    {
        var bundle = objj_msgSend(CPBundle, "mainBundle");
        var image = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "jp/Applications/TestApp2/icon.png");
...
class_addMethods(the_class, [new objj_method(sel_getUid("name"), function $TestApp2__name(self, _cmd)
{
    return "Test Application Two";
}
...
,["CPViewController"])]);
}p;32;Applications/TestApp1/TestApp1.jt;1916;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;1849;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPViewController, "TestApp1ViewController"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $TestApp1ViewController__init(self, _cmd)
{
    ...
    {
        var bundle = objj_msgSend(CPBundle, "mainBundle");
        var image = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "jp/Applications/TestApp1/icon.png");
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("controller")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("name"), function $TestApp1__name(self, _cmd)
{
...
,["CPViewController"])]);
}p;38;Applications/DesignerApp/ToolBoxView.jt;2592;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;2525;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPView, "ToolBoxView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("tableView"), new objj_ivar("elements")]);objj_registerClassPair(the_class);
...
,["int","CPTableView"]), new objj_method(sel_getUid("tableView:objectValueForTableColumn:row:"), function $ToolBoxView__tableView_objectValueForTableColumn_row_(self, _cmd, aTableView, aColumn, aRowIndex)
{
    ...
    return objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "jp/Applications/DesignerApp/Images/" + self.elements[aRowIndex] + ".png");
}
...
,["BOOL"])]);
}p;42;Applications/DesignerApp/DesignerAppView.jt;2709;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;13;ContentView.jt;2624;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("ContentView.j", YES);var TOPBARHEIGHT = 30;
...
,["id"])]);
}p;38;Applications/DesignerApp/DesignerApp.jt;868;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;27;DesignerAppViewController.jt;770;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("DesignerAppViewController.j", YES);{var the_class = objj_allocateClassPair(CPObject, "DesignerApp"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("controller")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("name"), function $DesignerApp__name(self, _cmd)
{
...
meta_class = the_class.isa;objj_registerClassPair(the_class);
}p;38;Applications/DesignerApp/ContentView.jt;4296;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;12;UITreeView.ji;13;ToolBoxView.jt;4194;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("UITreeView.j", YES);objj_executeFile("ToolBoxView.j", YES);var MINSIDEBARWIDTH = 200;
...
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $ContentView__init(self, _cmd)
{
    ...
    if (self)
    {
        ...
        objj_msgSend(self, "setAutoresizingMask:", CPViewWidthSizable | CPViewHeightSizable);
        objj_msgSend(self, "setDelegate:", self);
        var mainBackground = objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:", "jp/Applications/DesignerApp/910.jpg");
