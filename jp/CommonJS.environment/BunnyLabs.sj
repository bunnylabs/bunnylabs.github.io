@STATIC;1.0;p;16;SessionManager.jt;18552;@STATIC;1.0;I;23;Foundation/Foundation.ji;15;SessionWindow.ji;17;SessionMenuItem.ji;20;Utils/HashFragment.ji;22;Utils/URLQueryString.jt;18410;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("SessionWindow.j", YES);objj_executeFile("SessionMenuItem.j", YES);objj_executeFile("Utils/HashFragment.j", YES);objj_executeFile("Utils/URLQueryString.j", YES);var GITHUB_CLIENT_ID = "39cee75ce85db5da2576";
...
,["id"]), new objj_method(sel_getUid("handleSessionManagerMessage:"), function $SessionManager__handleSessionManagerMessage_(self, _cmd, anObject)
{
    ...
    if (anObject.type === "githubLogin")
    {
        ...
        else if (anObject.error)
        {
            ...
            objj_msgSend(objj_msgSend(self, "window"), "setCustomError:", objj_msgSend(CPString, "stringWithFormat:", "Githubでログインすることできません。原因: %@", anObject.error));
...
{
    var query = {auth: self.authToken, lang: "jp"};
...
,["id"])]);
}p;15;SessionWindow.jt;33499;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;20;TextFieldWithLabel.jt;33406;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("TextFieldWithLabel.j", YES);var LOGIN_STATE = 1;
...
,["void"]), new objj_method(sel_getUid("setTopView:"), function $DesktopManager__setTopView_(self, _cmd, aView)
{
    ...
    objj_msgSend(aView, "setAutoresizingMask:", CPViewMinXMargin | CPViewMaxXMargin | CPViewMinYMargin | CPViewMaxYMargin);
}
,["void","CPView"])]);
